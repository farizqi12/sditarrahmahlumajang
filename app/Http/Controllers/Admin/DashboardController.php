    ...
    public function index()
    {
        ...
        switch ($user->role->name) {
            case 'admin':
                ...
                return view('admin.dashboard', compact('totalUsers', 'totalStudents', 'totalTeachers', 'totalClasses', 'recentUsers'));
            case 'kepala_sekolah':
                ...
                return view('kepala_sekolah.dashboard', compact('academicYears', 'classes', 'subjects', 'averageSchoolGrade', 'totalStudents', 'attendanceRate', 'avgGradeByClass', 'avgGradeBySubject', 'topStudents', 'bottomStudents'));
            case 'guru':
