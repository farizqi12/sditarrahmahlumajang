...
<body>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <input name="password_confirmation" type="password"
                                                class="form-control mb-2" placeholder="Konfirmasi Password">

                                            <select name="role_id" class="form-select mb-2"
                                                onchange="toggleFields(this.value, '{{ $user->id }}')">
                                            ...
                                            <input type="text" name="nis" id="edit-nis-{{ $user->id }}"
                                                class="form-control mb-2 {{ optional($user->student)->nis ? '' : 'd-none' }}"
                                                placeholder="NIS (Siswa)"
                                                value="{{ old('nis', optional($user->student)->nis) }}" readonly>
                                            <input type="text" name="nip" id="edit-nip-{{ $user->id }}"
                                                class="form-control mb-2 d-none" placeholder="NIP"
                                                value="{{ old('nip', optional($user->teacher)->nip) }}">
                                        </div>
            ...
            <form action="{{ route('admin.users.store') }}" method="POST">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <input name="name" value="{{ old('name') }}" class="form-control mb-2" placeholder="Nama"
                            required>
                        ...
                        <input name="password" type="password" class="form-control mb-2" placeholder="Password"
                            required>
                        <input name="password_confirmation" type="password" class="form-control mb-2"
                        ...
                        <input type="text" name="nip" id="add-nip" class="form-control mb-2 d-none"
    ...
    <script>
        function toggleFields(roleId, context) {
            ...
            if (roleId == 2 && nipField) nipField.classList.remove('d-none'); // Role Guru
            if (roleId == 5 && nipField) nipField.classList.remove('d-none'); // Role Guru
