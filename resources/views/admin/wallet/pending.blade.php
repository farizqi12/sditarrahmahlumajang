...
<head>
    ...
    <title>Transaksi Pending - Admin</title>
    ...
    <div class="content">
        ...
        <div class="card p-3 mt-4">
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <a href="{{ route('admin.tabungan.index') }}" class="btn btn-secondary btn-sm">Kembali ke Daftar Tabungan</a>
            </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex gap-1">
                                        <form action="{{ route('admin.tabungan.updateStatus', $transaction->id) }}" method="POST">
                                            @csrf
                                            @method('PATCH')
