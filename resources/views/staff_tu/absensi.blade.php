...
<head>
    ...
    <title>Absensi Staff TU - E-Learning</title>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            async function performCheck(action) {
                ...
                const url = action === 'in' ? '{{ route('staff_tu.absensi.checkin') }}' :
                    '{{ route('staff_tu.absensi.checkout') }}';
            ...
            async function performScan(locationId) {
                ...
                const url = '{{ route('staff_tu.absensi.scan') }}';
