...
<head>
    ...
    <title>Detail Tabungan: {{ $user->name }} - Staff TU</title>
    ...
    <div class="content">
        ...
        <div class="card p-3 mt-4">
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <a href="{{ route('staff_tu.tabungan.index') }}" class="btn btn-secondary btn-sm">Kembali</a>
            </div>

            <div class="row">
                <div class="col-md-4">
                    <h6>Tambah Transaksi</h6>
                    <form action="{{ route('staff_tu.tabungan.store', $user->id) }}" method="POST">
                        @csrf
                        <div class="mb-3">
